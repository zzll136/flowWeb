...
window.onunload = function () {
    ...
    //     type: 'POST',
    //     async: false,
    //     url: '/experiment/finish',
    //     data: 'log=' + encodeURIComponent(document.getElementById('expLog').innerText)
    // });
}
var tableid = 7;
...
// var tableid=window.location.search.substr(1).match(tableid).index;
// var lastSW1=0, lastSW2=0, lastSW3=0, lastSW=0;
